...
func TestInitialize(t *testing.T) {
	...
	synchronisation.SetCabRequests(&system3, 1, elevatorConfig.Pending)
	synchronisation.SetHallRequests(&system3, 3, int(elevatorConfig.HallUp), elevatorConfig.Pending)
	synchronisation.SetHallRequests(&system3, 2, int(elevatorConfig.HallDown), elevatorConfig.Pending)

	synchronisation.UpdateElevatorSystemWithPeer(&system1, &system2, HallRequestsForAllElevators, CabRequestsForAllElevators)
	synchronisation.UpdateElevatorSystemWithPeer(&system1, &system3, HallRequestsForAllElevators, CabRequestsForAllElevators)
